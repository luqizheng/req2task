...
export class InitMigration1776666670586 implements MigrationInterface {
    name = 'InitMigration1776666670586'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "llm_configs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "provider" "public"."llm_configs_provider_enum" NOT NULL DEFAULT 'openai', "apiKey" character varying(500) NOT NULL, "base_url" character varying, "model_name" character varying(100) NOT NULL, "max_tokens" integer NOT NULL DEFAULT '4096', "temperature" numeric(3,2) NOT NULL DEFAULT '0.7', "top_p" numeric(3,2) NOT NULL DEFAULT '1', "is_active" boolean NOT NULL DEFAULT true, "is_default" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_59d393b0d96abb589b3d0a1aa5b" PRIMARY KEY ("id"))`);
