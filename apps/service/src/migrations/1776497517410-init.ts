...
export class Init1776497517410 implements MigrationInterface {
    name = 'Init1776497517410'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "raw_requirement_collections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "project_id" uuid NOT NULL, "title" character varying NOT NULL, "collection_type" "public"."raw_requirement_collections_collection_type_enum" NOT NULL, "collected_by_id" uuid NOT NULL, "collected_at" TIMESTAMP NOT NULL, "meeting_minutes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6e5ad9193404cd037b4c01e069a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "raw_requirements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "collection_id" uuid, "module_id" character varying NOT NULL, "original_content" text NOT NULL, "status" "public"."raw_requirements_status_enum" NOT NULL DEFAULT 'pending', "source" character varying(200), "generated_content" text, "error_message" text, "session_history" json, "follow_up_questions" json, "key_elements" json, "created_by_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b6816af5a9ade6212b38528d6a6" PRIMARY KEY ("id"))`);
