...
export class Init1776648728370 implements MigrationInterface {
    name = 'Init1776648728370'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "collection_id" uuid, "raw_requirement_id" uuid, "next_conversation_id" uuid, "title" character varying(255), "status" "public"."conversations_status_enum" NOT NULL DEFAULT 'active', "message_count" integer NOT NULL DEFAULT '0', "summary" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee34f4f7ced4ec8681f26bf04ef" PRIMARY KEY ("id"))`);
