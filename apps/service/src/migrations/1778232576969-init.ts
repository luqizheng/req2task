...
export class Init1778232576969 implements MigrationInterface {
    name = 'Init1778232576969'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "projects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text, "project_key" character varying NOT NULL, "status" "public"."projects_status_enum" NOT NULL DEFAULT 'planning', "start_date" date, "end_date" date, "owner_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "system_type" "public"."projects_system_type_enum", "architecture_type" "public"."projects_architecture_type_enum", "tech_stack" jsonb, "database_types" "public"."projects_database_types_enum" array, "cloud_provider" "public"."projects_cloud_provider_enum", "security_level" "public"."projects_security_level_enum", "project_scale" "public"."projects_project_scale_enum", "team_size" integer, "is_microservices" boolean NOT NULL DEFAULT false, "expected_duration_months" integer, "budget" numeric, "business_domain" text, "target_audience" text, "wizard_completed" boolean NOT NULL DEFAULT false, "wizard_config" jsonb, CONSTRAINT "UQ_c655a93948868c0af4c102745e0" UNIQUE ("project_key"), CONSTRAINT "PK_6271df0a7aed1d6c0691ce6ac50" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "next_conversation_id" uuid, "title" character varying(255), "status" "public"."conversations_status_enum" NOT NULL DEFAULT 'active', "message_count" integer NOT NULL DEFAULT '0', "summary" text, "conversation_type" character varying(50) NOT NULL DEFAULT 'general', "metadata" json, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee34f4f7ced4ec8681f26bf04ef" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "task_no" character varying NOT NULL, "entity_key" character varying NOT NULL, "title" character varying NOT NULL, "description" text, "requirement_id" uuid NOT NULL, "status" "public"."tasks_status_enum" NOT NULL DEFAULT 'todo', "priority" "public"."tasks_priority_enum" NOT NULL DEFAULT 'medium', "assigned_to_id" uuid, "estimated_hours" numeric(10,2), "actual_hours" numeric(10,2), "due_date" TIMESTAMP, "parent_task_id" uuid, "replaced_by_task_id" uuid, "cancelled_reason" text, "cancellation_type" character varying(50), "conversation_id" uuid, "created_by_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_dcf498eb49a3684b842e6dc3be8" UNIQUE ("task_no"), CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "file_data" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "file_hash" character varying(32) NOT NULL, "original_name" character varying(255) NOT NULL, "mime_type" character varying(100) NOT NULL, "size" bigint NOT NULL, "storage_path" character varying(500) NOT NULL, "status" "public"."file_data_status_enum" NOT NULL DEFAULT 'pending_delete', "created_by_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_69875c852f5133f7ebea403609b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tasks_dependencies" ("task_id" uuid NOT NULL, "dependency_id" uuid NOT NULL, CONSTRAINT "PK_9800aac4650fa9400443cfa967e" PRIMARY KEY ("task_id", "dependency_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_74941a1d3c194de007238fc1a3" ON "tasks_dependencies" ("task_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_02c32e5fdf75e5ba3befa5c730" ON "tasks_dependencies" ("dependency_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "tasks_dependencies" ADD CONSTRAINT "FK_74941a1d3c194de007238fc1a3c" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "tasks_dependencies" ADD CONSTRAINT "FK_02c32e5fdf75e5ba3befa5c730f" FOREIGN KEY ("dependency_id") REFERENCES "tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tasks_dependencies" DROP CONSTRAINT "FK_02c32e5fdf75e5ba3befa5c730f"`);
        await queryRunner.query(`ALTER TABLE "tasks_dependencies" DROP CONSTRAINT "FK_74941a1d3c194de007238fc1a3c"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_02c32e5fdf75e5ba3befa5c730"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_74941a1d3c194de007238fc1a3"`);
