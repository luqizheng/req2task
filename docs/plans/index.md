...
| Sprint 05 | [AI 配置与对话](sprint-05-frontend-ai-chat.md) | ⏳ 待开始 | AiConfigView、AI Chat 集成 | M3 |
| Sprint 06 | [AI 需求生成](sprint-06-frontend-ai-requirement-gen.md) | ⏳ 待开始 | 需求生成、用户故事、验收条件生成 UI | M3 |
